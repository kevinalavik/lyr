...
const lyrterm_theme_t lyrterm_theme_dark = {
    ...
    .bg   = 0x00000000,
    .ansi_normal = {
        0x00000000, 0x00d75f5f, 0x005f875f, 0x00af875f,
        0x005f5f87, 0x00875f87, 0x005f8787, 0x00a8a8a8,
    },
    .ansi_bright = {
        0x00606060, 0x00ff8787, 0x0087af87, 0x00ffd787,
        0x008787af, 0x00af87af, 0x0087afaf, 0x00ffffff,
    },
};
...
const lyrterm_theme_t lyrterm_theme_light = {
    ...
    .bg   = 0x00fdfdfd,
    .ansi_normal = {
        0x00000000, 0x00b03030, 0x00306030, 0x00808030,
        0x003030b0, 0x00803080, 0x00308080, 0x00707070,
    },
    .ansi_bright = {
        0x00505050, 0x00d05050, 0x00509050, 0x00c0a050,
        0x005050d0, 0x00a050a0, 0x0050a0a0, 0x00ffffff,
    },
};
